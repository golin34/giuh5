Invoke-WebRequest https://github.com/2captcha/rucaptcha-bot/releases/download/win32-ia32-prod-v2.4.3/CaptchaBotRS.Setup.2.4.3.exe -OutFile CaptchaBotRS.Setup.2.4.3.exe
copy CaptchaBotRS.Setup.2.4.3.exe C:\Users\Public\Desktop\CaptchaBotRS.Setup.2.4.3.exe
